...
<?php
	...
	$phone = $row['phone'];
	$address = $row['address'];
	$imageName = $row['admin_image'];
	$role = $row['role_id'];
	$upupdated = $row['updated_on'];
...
<head>
	...
	<!--plugins-->
	<link rel="stylesheet" href="assets/css/new_one.css">
    <link rel="stylesheet" href="assets/css/new_one.map.css">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="add_product"><i class="bx bx-right-arrow-alt"></i>Add Products</a></li>
						<li> <a href="view_product"><i class="bx bx-right-arrow-alt"></i>View Products</a></li>
					</ul>
				</li>
				<li>
					<a href="javascript:;" class="has-arrow">
					...
					<ul>
						<li> <a href="add_purchase"><i class="bx bx-right-arrow-alt"></i>Add Purchase</a></li>
						<li> <a href="view_purchases"><i class="bx bx-right-arrow-alt"></i>View Purchases</a></li>
					</ul>
				</li>
				<li>
				<li>
					...
					<ul>
						<li> <a href="add_sales"><i class="bx bx-right-arrow-alt"></i>Make Sales</a></li>
						<li> <a href="view_sales"><i class="bx bx-right-arrow-alt"></i>View Sales</a></li>
					</ul>
				</li>
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Categories & Units</div>
					</a>
					<ul>
						<li> <a href="add_role"><i class="bx bx-right-arrow-alt"></i>Add Role</a></li>
						<li> <a href="add_category"><i class="bx bx-right-arrow-alt"></i>Add Category</a></li>
						<li> <a href="view_category"><i class="bx bx-right-arrow-alt"></i>View Categories</a></li>
						<li> <a href="add_unit"><i class="bx bx-right-arrow-alt"></i>Add Unit</a></li>
						<li> <a href="view_unit"><i class="bx bx-right-arrow-alt"></i>View Unit</a></li>
					</ul>
				</li>
				<li class="menu-label">Public Pages</li>
				<li>
					<a href="all_products">
				...
				<li class="menu-label">Account Control</li>
				<li>
					<a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li> <a href="user_profile"><i class="bx bx-right-arrow-alt"></i>My Profile</a></li>
						<li> <a href="reset_password"><i class="bx bx-right-arrow-alt"></i>Reset Password</a></li>
					</ul>
				</li>
				<li>
					<a class="has-arrow" href="javascript:;">
					...
					<ul>
						<li> <a href="register"><i class="bx bx-right-arrow-alt"></i>New account</a></li>
						<li> <a href="accounts"><i class="bx bx-right-arrow-alt"></i>View accounts</a></li>
					</ul>
				</li>
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="assets/images/uploads_admin/<?php echo $imageName; ?>" class="user-img" alt="user avatar">
							<div class="user-info ps-3">
								<p class="user-name mb-0"><?php echo $fullname; ?></p>
								<p class="designattion mb-0"><?php echo $role_name; ?></p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="user_profile"><i class="bx bx-user"></i><span>Profile</span></a>
							</li>
							...
							<li><a class="dropdown-item" href="connect/logout?username=<?php echo $username; ?>"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
						<div class="col-12">
						<a href="cart">
							<div class="btn-group" role="group">
								  <div id="btnGroupDrop1" type="" class="btn btn-white px-1" style="width: 50px;">
								  <i class='bx bx-cart-alt'></i>
								  <?php
								  
									 if (isset($_SESSION['cartigo'])) {
										 $countess = count($_SESSION['cartigo']);
										 echo "<span class='superscript'>$countess</span>";
									 }else {
										echo "<span class='superscript'>0</span>";
									 }
