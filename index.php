...
if(isset($_POST['submit'])){
    ...
    if(empty($username) || empty($pass)){
        $errorMsg = "Username and Password are required to sign in !";
		echo "<script>alert('$errorMsg'); window.location='index';</script>";
    }else{
        $password = md5($pass);
        
        $checkUser = dbconnect()->prepare("SELECT * FROM register WHERE username=? && password=?");
        ...
        if($no >0){
            	...
            	echo "<script>alert('$msg'); window.location='dashboard';</script> ";
...
<head>
	...
	<title>Rocker - Bootstrap 5 Admin Dashboard</title>
</head>
									...
									<div class="form-body">
										<form class="row g-3" method="POST">
											<div class="col-12">
												...
												<input type="text" class="form-control" id="inputEmailAddress" name="username" placeholder="Enter login ID...">
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Enter Password</label>
												<div class="input-group" id="show_hide_password">
													<input type="password" minlength="6" class="form-control border-end-0" name="pass" id="inputChoosePassword" placeholder="Enter password..."> <a class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-md-6">
											...
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" name="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Login</button>
												</div>
											</div>
										</form>
									</div>
