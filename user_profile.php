...
<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<a href="reset_password?id=<?php echo $id; ?>">
						<div class="btn-group">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											<img src="assets/images/uploads_admin/<?php echo $imageName ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
											<div class="mt-3">
												<h4><?php echo $fullname; ?></h4>
												<p class="text-secondary mb-1"><?php echo $role_name; ?></p>
									...
									<hr class="my-44" />
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="upname" class="form-control" value="<?php echo $fullname; ?>" />
											</div>
										</div>
                                        <div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 col-md-6 text-secondary">
												<input type="number" min="18" name="upage" class="form-control" value="<?php echo $age; ?>" />
											</div>
										</div>
                                        <div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" min-length="6" name="upusername" class="form-control" value="<?php echo $username; ?>" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="upphone" class="form-control" value="<?php echo $phone; ?>" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="email" name="upemail" class="form-control" value="<?php echo $email; ?>" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="upaddress" class="form-control" value="<?php echo $address; ?>" />
											</div>
										</div>
										<div class="row">
											<div class="col-sm-3"></div>
											<div class="col-sm-9 text-secondary">
												<input type="submit" name="submit" class="btn btn-primary px-4" value="Update" onclick ="return confirm('Are you sure you want to update? You have to login again!')" />
											</div>
										</div>
									</div>
								</div>
